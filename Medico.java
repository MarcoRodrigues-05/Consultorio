...
class Medico {
    ...
    public static void cadastrarMedico(){
        ...
        System.out.print("Digite o período de atendiemnto do médico: ");
    ...
    public static void mostrarMedicos(){
        ...
        for(int i=0; i<listaMedicos.size(); i++){
            ...
            System.out.print(" /CRM: "+listaMedicos.get(i).crm);
            System.out.print(" /Especialidade: "
                    +listaMedicos.get(i).especialidade);
            System.out.print(" /Telefone: "+listaMedicos.get(i).telefone);
